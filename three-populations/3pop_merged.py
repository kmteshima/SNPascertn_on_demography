...
def main(nsam_discovery, nsam_type, MAF, marker_size, msfile, save_dir, file_name):
    ...
    pop1_df.to_csv("{}/asc2_pop1_sfs_{}.csv".format(save_dir, file_name))
    pop2_df.to_csv("{}/asc2_pop2_sfs_{}.csv".format(save_dir, file_name))
    pop3_df.to_csv("{}/asc2_pop3_sfs{}.csv".format(save_dir, file_name))
