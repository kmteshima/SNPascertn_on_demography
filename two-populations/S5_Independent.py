...
def make_ms_command(pop1_small, pop1_large,
    ...
    cmd += "> {}/AP{}BI_eachMAF_{}.txt".format(save_dir, AP_num, file_name)
...
def small_sampling(msdata, pop1_small, pop1_large, pop2_small, pop2_large):
    ...
    discovery_panel = np.r_[msdata[pop1_small:pop1_small + pop1_large],
                            msdata[pop1_small + pop1_large + pop2_small:
...
def listup_snp_marker(discovery, pop1_small, pop1_large, pop2_small, pop2_large, MAF):

    # Make SNP Marker
    SNP_pos = []
    SNP_pos.extend(eachMAF(discovery[pop1_small:pop1_small + pop1_large], MAF))
    SNP_pos.extend(eachMAF(discovery[pop1_small + pop1_large + pop2_small:
                                     pop1_small + pop1_large + pop2_small + pop2_large], MAF))
...
def main(pop1_small, pop1_large, pop2_small, pop2_large,
    ...
    msfile = "{}/AP{}BI_eachMAF_{}.txt".format(save_dir, AP_num, file_name)
    ...
    for msdata in [m["seq"] for m in parse_ms_data(msfile)]:
        ...
        # Make SNP Marker
        marker_cand = listup_snp_marker(discovery_panel, pop1_small, pop1_large, pop2_small, pop2_large, MAF)
...
if __name__ == "__main__":
    ...
    AP_num = "i"
    file_name = "S5_independent_MAF{}".format(int(MAF * 100))
