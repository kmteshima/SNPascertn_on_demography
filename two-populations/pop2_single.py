...
def main(nsam_discovery, nsam_type, MAF, marker_size, msfile, save_dir, file_name):
    ...
    for m in parse_ms_data(msfile):
        ...
        if sum(marker_cand) >= marker_size:
            ...
            # return list of list of int
            pop1_typing, pop2_typing = typing(msdata,nsam_discovery,nsam_type, snp_marker)
    ...
    pop1_df.to_csv("{}/asc1_pop1_sfs_{}.csv".format(save_dir, file_name))
    pop2_df.to_csv("{}/asc1_pop2_sfs_{}.csv".format(save_dir, file_name))
...
if __name__ == "__main__":
    ...
    # input data
    msfile = "Is2_single_mrate01.txt"

    # save directory
    save_dir = ""
    file_name = "Is2_single_MAF{}".format(int(MAF * 100))
