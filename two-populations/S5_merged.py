...
def main(pop1_small, pop1_large, pop2_small, pop2_large,
    ...
    pop1_df.to_csv("{}/AP{}BI_pop1_SFS_{}.csv".format(save_dir, AP_num, file_name))
    pop2_df.to_csv("{}/AP{}BI_pop2_SFS_{}.csv".format(save_dir, AP_num, file_name))
    stats_df.to_csv("{}/AP{}BI_stats_{}.csv".format(save_dir, AP_num, file_name))
